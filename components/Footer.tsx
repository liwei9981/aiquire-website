...
import { TransfongLogo } from './Header.tsx';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2 space-y-8">
            <TransfongLogo isDark={document.documentElement.classList.contains('dark')} className="h-12" />
        ...
        <div className="border-t border-slate-200 dark:border-navy-800 pt-10 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-sm text-slate-400">© 2024 Transfong. All rights reserved.</p>
